...
export const LandingPage = () => {
  return (
    <div className="h-screen bg-[#2e2d33] border-4 border-[#fef4ce] [box-shadow:5px_5px_#fef4ce] mx-9 rounded-lg flex justify-between items-center space-y-8 text-[#fef4ce]">
      <Image
